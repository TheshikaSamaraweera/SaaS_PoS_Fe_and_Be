// src/app/static-frontpage/page.tsx

import Head from 'next/head';
import Footer from '@/components/ui/footer';

// Example images imported from the '/public' directory
  ...
  <div className="container mx-auto flex items-center justify-between">
    ...
    <nav>
      <ul className="flex space-x-4">
        <li><a href="#" className="text-gray-800 hover:text-blue-600 transition duration-300 ease-in-out">Features</a></li>
        <li><a href="#" className="text-gray-800 hover:text-blue-600 transition duration-300 ease-in-out">Pricing</a></li>
        <li><a href="#" className="text-gray-800 hover:text-blue-600 transition duration-300 ease-in-out">Contact</a></li>
      </ul>
    </nav>
  </div>
</header>
